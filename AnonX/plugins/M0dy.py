...
async def for_users (app,m):
   if check(m.from_user.id):
     ...
     return await m.reply_photo(
        ...
        caption=f"""[ ●━◉⟞⟦ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 • 𝐙𝐄 🔱 ⟧⟝◉━● •](https://t.me/UI_XB)\n\n**اهـلا يـنـجـم.؟ **\n**مـرحبآ بـك انــا بــوت اقـوم بــتـشـغـيـل الاغــانــي فـي الـمـڪـالـمـه الـصـوتـية .🤔❤**\n**يمكنني التشغيل بصوت رائع وبدون اي مشاكل او تقطيع في الاغنيه**\n**اضفني الى مجموعتك وارفعني رول بشڪل مع ڪامل الصلاحيات صحيح**\n**لمعرفة استخدامي بشڪل صحيح اضغط علي زر الاوامر. 🤔💕**\n
اضغط(/sezar)لاظهار كيب المطور ✨
[ ●━◉⟞⟦ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 • 𝐙𝐄 🔱 ⟧⟝◉━● •](https://t.me/UI_XB)""", reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "مطور السورس. ⚡", url=f"https://t.me/UP_UO"),
            ],[
                    InlineKeyboardButton(
                        "قناة السورس⚡", url=f"https://t.me/UI_XB"),
            ],[
                    InlineKeyboardButton(
                        " اضغط هنا لاضافتي الي مجموعتك🤖", url=f"https://t.me/S1CXBOT?startgroup=true"),
            ], 
            ]
        ),
    )
    
   kep = ReplyKeyboardMarkup([["《مطور البوت》", "《مطور السورس》"], ["《اضافه البوت لمجموعتك》"], ["《السورس》", "《جروب السورس》"], ["✨بنك قيصر", "⋖━❲𖣂❳━⋗", "✨ابراج"], ["✨ازكار", "⋖━❲𖣂❳━⋗", "✨اسال"], ["●━◉⟞⟦ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 • 𝐙𝐄 🔱 ⟧⟝◉━●"], ["زخرفه", "⋖━❲𖣂❳━⋗", "✨زخارف"], ["✨حكمه", "⋖━❲𖣂❳━⋗", "✨معلومات"], ["✨العاب", "⋖━❲𖣂❳━⋗", "✨اغاني"], ["✨مهنتي", "⋖━❲𖣂❳━⋗", "✨افلام"], ["✨كت", "⋖━❲𖣂❳━⋗", "✨تويت"], ["✨رايك بصورتي", "⋖━❲𖣂❳━⋗", "✨حساب العمر"], ["●━◉⟞⟦ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 • 𝐙𝐄 🔱 ⟧⟝◉━●"], ["✨حذف حسابي", "⋖━❲𖣂❳━⋗", "✨انصحني"], ["✨مميزات", "⋖━❲𖣂❳━⋗", "✨بوت"], ["✨نكته", "⋖━❲𖣂❳━⋗", "✨حروف"], ["✨صوره", "⋖━❲𖣂❳━⋗", "✨غنيلي"], ["✨انمي", "⋖━❲𖣂❳━⋗", "✨متحركه"], ["✨اقتباسات", "⋖━❲𖣂❳━⋗", "✨هيدرات"], ["●━◉⟞⟦ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 • 𝐙𝐄 🔱 ⟧⟝◉━●"], ["✨صور بنات", "⋖━❲𖣂❳━⋗", "✨صور شباب"], ["✨قران", "⋖━❲𖣂❳━⋗", "✨الشيخ نقشبندي"], ["✨استوريهات", "⋖━❲𖣂❳━⋗", "✨فيلم"], ["✨ايدي", "⋖━❲𖣂❳━⋗", "✨خيرني"], ["🥺 ¦ حذف الكيبورد"]], resize_keyboard=True)
   await m.reply_photo(
        photo=f"https://telegra.ph/file/5116db79f852db113875c.jpg",
        caption=f"""[ ●━◉⟞⟦ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 • 𝐙𝐄 🔱 ⟧⟝◉━● •](https://t.me/UI_XB)\n\n**اهـلا يـنـجـم.؟ **\n**مـرحبآ بـك انــا بــوت اقـوم بــتـشـغـيـل الاغــانــي فـي الـمـڪـالـمـه الـصـوتـية .🤔❤**\n**يمكنني التشغيل بصوت رائع وبدون اي مشاكل او تقطيع في الاغنيه**\n**اضفني الى مجموعتك وارفعني رول بشڪل مع ڪامل الصلاحيات صحيح**\n**لمعرفة استخدامي بشڪل صحيح اضغط علي زر الاوامر. 🤔💕**\n
  ...
  if m.text in admins_commands:
    if not check(m.from_user.id):
      ...
      if m.text == '《ضع قناة الاشتراك》':
        await m.reply("• ارسل معرف القناة العام مثال @UI_XB", quote=True)
    ...
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "رابط الحذف🗑", url=f"https://t.me/SIOFBOT"),
            ],
            ]
        ),
    )
    ...
    await message.reply_photo(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "رابط الجروب ✨", url=f"https://t.me/UI_OS"),
            ],
            ]
        ),
    )
...
@app.on_message(filters.command(["●━◉⟞⟦ 🔱 𝐒𝐎𝐔𝐑𝐂𝐄 • 𝐙𝐄 🔱 ⟧⟝◉━●"], ""))
async def upbkgt(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/5116db79f852db113875c.jpg",
        caption=f"""صلي علي النبي وتبسم ✨💖""",
...
async def upbkgt(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph/file/5116db79f852db113875c.jpg",
        caption=f"""قم باضافتي لمجوموعتك لتشغيل الموسيقي والفديو في المحادثه الصوتيه انا من اسرع البوتات التي تستطيع تشغيل الاغاني تم تنصيبي في افضل سورس في التلجرام سورس زد إي قناه السورس @UI_XB""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
